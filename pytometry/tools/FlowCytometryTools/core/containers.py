...
class FCMeasurement(Measurement):
    ...
    def __init__(self, ID,
        ...
        super().__init__(ID, datafile=datafile, readdata=readdata, readdata_kwargs=readdata_kwargs, metafile=metafile, readmeta=readmeta,
                         readmeta_kwargs=readmeta_kwargs)
        self.__gatesList = None     # list of gates
        self.__g = None             # gui object
    ...
    def gate(self, gate, apply_now=True):
        ...
        data = self.get_data()
        newdata = gate(data)
        newsample = self.copy(deep=False)
