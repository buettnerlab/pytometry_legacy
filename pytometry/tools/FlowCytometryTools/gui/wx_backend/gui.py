...
class GUIEmbedded(GeneratedWireframe):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__gatesList = None
        #self.gateName = None #Felix

    def get_gatesList(self):
        return self.__gatesList
    ...
    def btn_gen_code(self, event):
        ...
        self.__gatesList = self.fcgatemanager.get_gates()  #Generates list of gates #Felix
